...
import {  userImageRoleProps } from '@/types/tblog'


function MenuLink({avatar,role}:userImageRoleProps) {
    ...
    <div className='flex flex-col md:flex-row w-full md:w-auto '>
        ...
        <Link className='w-full text-2xl px-4 py-2 text-white font-intel border-l-2 flex-center' href={'/my-blog'}>MyBlog</Link>
        {
          role !== 'admin' ? (
            ...
            <Link className='w-full text-2xl px-4 py-2 text-white font-intel border-2 flex-center' href={'/admin'}>Admin</Link>
          )
        }
